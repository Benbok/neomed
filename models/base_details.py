...
class NeomedJournal(models.Model):
    ...
    time = fields.Char(string='Время рождения', default="10-00")
    text = fields.Text(string='Содержание')
    day_nomber = fields.Char(string='Сутки жизни', default="10-00")
    day_field = fields.Char(string='Содержание', default="1-е сутки")